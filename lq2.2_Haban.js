...
const my_password = "Pointbreak150"; // sample stored password
...
switch (item_choice) { // will switch until the valid case 
    case "A":
        ...
        alert(`Pepsi Cola have been selected. Total Price: Php ${price * quantity}`);
        break;
    case "B":
        price = 35.00;
        alert(`Coca Cola have been selected. Total Price: Php ${price * quantity}`);
        break;
    case "C":
        price = 100.00;
        alert(`Apple have been selected. Total Price: Php ${price * quantity}`);
        break;
    case "D":
        price = 120.00;
        alert(`Orange have been selected. Total Price: Php ${price * quantity}`);
        break;
    case "E":
        price = 180.00;
        alert(` Hotdogs have been selected. Total Price: Php ${price * quantity}`);
        break;
    default://the default case if input is not a-e
        alert("Invalid choice! Please enter a letter!! (A-E).");
}